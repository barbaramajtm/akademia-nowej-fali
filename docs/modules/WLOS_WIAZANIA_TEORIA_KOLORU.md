...
|--------|------------------------|-------------|--------------|
| **L1** `wlos-z-czego-sklada-sie` | `hair-composition.png` | — | Jedyna plansza składu; wzorcowa kompozycja edytorialna zgodna z `ILLUSTRATION_GUIDE.md`. Wymaga korekty treści procentów przed publikacją (R1–R4). |
| **L2** `wlos-oslonka-kora-rdzen` | `hair-layers.png` | — | Jedyny schemat trzech warstw łodygi. Merytorycznie trafny; przed publikacją — usunięcie dekoracji botanicznych (R13). |
| **L3** `wlos-keratyna-rusztowanie` | `hair-fibrous-keratin.png` | `hair-keratin-formation.png`, `hair-cortex-structure.png` | **Preferowana:** pokazuje uproszczony model spirale peptydowe → keratyna włóknista — bliżej głównej myśli L3 niż hierarchia kory. Termin „włóknista” bliższy językowi dydaktycznemu niż „płaska”. **Alternatywy odrzucone jako główna ilustracja:** `hair-keratin-formation.png` — termin „keratyna płaska” niepotwierdzony w materiałach egzaminowych (R11); `hair-cortex-structure.png` — za głęboka hierarchia bez źródła egzaminowego (R12). **Nie przypisywać do L3:** `hair-amorphous-keratin.png` — typologia spoza zakresu egzaminowego. |
...
|------|-------|-------------------|-------|
| `assets/images/hair-composition.png` | Skład włosa: keratyna, woda, lipidy | L1 | Plansza referencyjna stylu projektu |
| `assets/images/hair-layers.png` | Osłonka, kora, rdzeń | L2 | R13: dekoracje botaniczne |
| `assets/images/hair-fibrous-keratin.png` | Spirale peptydowe → keratyna włóknista | L3 (preferowana) | R11: uproszczony model |
| `assets/images/hair-keratin-formation.png` | Spirale peptydowe → „keratyna płaska” | Alternatywa L3 | R11: termin do weryfikacji |
| `assets/images/hair-amorphous-keratin.png` | Spirala → keratyna amorficzna | — (reference-only) | Nie w typologii egzaminowej |
| `assets/images/hair-cortex-structure.png` | Hierarchia kory (Rys. 3.38) | — (reference-only) | R12: model edukacyjny, za głęboki na L3 |
...
|------|---------------------|---------------------------|-----------------|----------------------|
| `hair-composition.png` | **requires-content-revision** | Procenty 80–90% / 10–15% bez potwierdzenia w Mat. pyt. 7 (R1–R2); lipidy „chronią” — uproszczenie (R3); stopka absolutyzuje rolę trzech składników (R4) | **ready** | Wzorcowa kompozycja edytorialna; miękkie plamy konstrukcyjne; brak liści, gwiazdek, serduszek |
| `hair-layers.png` | **ready** | Trzy warstwy i podpisy zgodne z Technologia pyt. 12; kora = kolor, siła, elastyczność — akceptowalne uproszczenie | **requires-visual-revision** | Złote gałązki liści, gwiazdki, serduszko — sprzeczne z `ILLUSTRATION_GUIDE.md` §2–3 (R13) |
| `hair-fibrous-keratin.png` | **requires-content-revision** | Spirale „tworzą” keratynę włóknistą bezpośrednio — pomija pośrednie poziomy (R11); stopka przypisuje wytrzymałość **i** elastyczność wyłącznie keratynie włóknistej | **requires-visual-revision** | Liście, gwiazdki, serduszka w stopce — dekoracje do usunięcia |
| `hair-keratin-formation.png` | **requires-content-revision** | Termin „keratyna płaska” nie występuje w materiałach projektu (R11); ten sam uproszczony model powstawania | **requires-visual-revision** | Liście, gwiazdki, serduszko |
| `hair-amorphous-keratin.png` | **reference-only** | Keratyna amorficzna — brak w banku egzaminowym; nie uczyć jako obowiązkowej typologii (R11) | **ready** | Czysty schemat procesu, bez ornamentów lifestyle |
| `hair-cortex-structure.png` | **reference-only** | Hierarchia makrofibryla → mikrofibryla → protofibryla → spirala — model podręcznikowy (R12); brak w Mat./Technologia JPG | **ready** | Styl podręcznikowy (Rys. 3.38); czytelny, bez dekoracji |
| `hair-growth-cycle.png` | **requires-content-revision** | Fazy poprawne; zwrot „do 15 razy w życiu” — DO WERYFIKACJI z Mat. pyt. 35; grafika spoza `source-materials/` | **ready** | Anatomiczny styl edukacyjny; brak ornamentów |
| `hair-hydrogen-bonds.png` | **ready** | Mostki O–H między spirale — zgodne z Technologia pyt. 6, 18 | **requires-visual-revision** | Liście, serduszko, gwiazdki — dekoracje do usunięcia |
...
| **Ilustracja** | `assets/images/hair-layers.png` (przed publikacją: visual revision R13 — usunąć motywy botaniczne) |
...
| **Ilustracja** | `assets/images/hair-fibrous-keratin.png` — preferowana dla L3; w `imageCaption` dopisek o uproszczonym modelu (R11); alternatywy: `hair-keratin-formation.png`, `hair-cortex-structure.png` (patrz §5.2); **nie** używać więcej niż jednej grafiki w lekcji |
...
- [ ] Visual revision grafik L2, L3, L8 przed publikacją (§5.4)
- [ ] Content revision `hair-composition.png` — procenty i stopka (R1–R4)
