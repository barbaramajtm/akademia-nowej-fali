...
|--------|------------------------|-------------|--------------|
| **L1** `wlos-z-czego-sklada-sie` | `hair-composition.png` *(do wstawienia)* | — | Plik usunięty 21 lipca 2026 — wstawić nową planszę od właścicielki (włos + karty 1–3 KERATYNA/WODA/LIPIDY). |
